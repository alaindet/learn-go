...
type Movie struct {
	...
	Runtime   MovieRuntime `json:"runtime,omitempty"`
...
func (m *MovieModel) GetAll(
	...
	if err != nil {
		return nil, common.PaginationMetadata{}, err
	}
	...
	metadata := common.CalculateMetadata(total, filters.Page, filters.PageSize)
